...
public class PlaybackState {
     ...
     * 判断是否已暂停
     *
     * @return 如果当前状态为PAUSED则返回true，否则返回false
     */
     ...
     * 判断是否已停止
     *
     * 停止状态包括STOPPED和IDLE，这两种状态下播放器都不处于活动播放状态。
     *
     * @return 如果当前状态为STOPPED或IDLE则返回true，否则返回false
     */
     ...
     * 判断是否有错误
     *
     * @return 如果当前状态为ERROR则返回true，否则返回false
     */
