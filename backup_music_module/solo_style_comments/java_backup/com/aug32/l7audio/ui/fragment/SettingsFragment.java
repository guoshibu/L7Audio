...
import com.aug32.l7audio.receiver.BootReceiver;
...
public class SettingsFragment extends BaseFragment {
    ...
    private void displayAudioRoutes() {
        ...
        try {
            ...
            routesInfo.append("音频模式: ").append(getModeName(mode)).append("\n");
            ...
            routesInfo.append("扬声器状态: ").append(isSpeakerphoneOn ? "开启" : "关闭").append("\n");
            routesInfo.append("蓝牙SCO状态: ").append(isBluetoothScoOn ? "开启" : "关闭").append("\n");
            routesInfo.append("有线耳机状态: ").append(isWiredHeadsetOn ? "已连接" : "未连接").append("\n");
            routesInfo.append("蓝牙A2DP状态: ").append(isBluetoothA2dpOn ? "已连接" : "未连接").append("\n");
            ...
            routesInfo.append("铃声模式: ").append(ringerModeName).append("\n");
    ...
    private void testTTS() {
        ...
        try {
            ...
            tvTTSStatus.setText(success ? "TTS测试成功！正在播放。" : "TTS测试失败。");
        } catch (Exception e) {
    ...
    private void enumMicrophones() {
        ...
        try {
            android.media.AudioManager audioManager = (android.media.AudioManager) requireContext().getSystemService(android.content.Context.AUDIO_SERVICE);
            micInfo.append("扬声器状态: ").append(audioManager.isSpeakerphoneOn() ? "开启" : "关闭").append("\n");
    ...
    private void enumOutputDevices() {
        ...
        try {
            android.media.AudioManager audioManager = (android.media.AudioManager) requireContext().getSystemService(android.content.Context.AUDIO_SERVICE);
            outputInfo.append("蓝牙SCO: ").append(audioManager.isBluetoothScoOn() ? "开启" : "关闭").append("\n");
            outputInfo.append("有线耳机: ").append(audioManager.isWiredHeadsetOn() ? "已连接" : "未连接").append("\n");
            outputInfo.append("蓝牙A2DP: ").append(audioManager.isBluetoothA2dpOn() ? "已连接" : "未连接").append("\n");
    ...
    private void enumCarOutputDevices() {
        ...
        outputInfo.append("当前音频模式: ").append(getModeName(audioOutputManager.getMode())).append("\n");
        tvAudioDeviceStatus.setText(outputInfo.toString());
    }
    ...
    private void saveAudioDeviceSettings() {
        try {
            ...
            micConfig.setMaxAmplification(maxAmplification);
            ...
            try {
                ttsManager.speakWithUsage("音频设备设置已保存", audioOutputUsageCar);
            } catch (Exception e) {
